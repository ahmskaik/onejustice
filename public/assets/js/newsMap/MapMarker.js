...
// MarkerLabel_ inherits from <code>OverlayView</code>:
    ...
    MarkerLabel_.prototype.onAdd = function () {
        ...
        this.listeners_ = [
            ...
            google.maps.event.addListener(this.containerDiv_, "mouseover", function (e) {
                me.containerDiv_.style.cursor = "pointer";
                google.maps.event.trigger(me.marker_, "mouseover", e);
            }),
            google.maps.event.addListener(this.containerDiv_, "mouseout", function (e) {
                me.containerDiv_.style.cursor = me.marker_.getCursor();
                google.maps.event.trigger(me.marker_, "mouseout", e);
            }),
            google.maps.event.addListener(this.containerDiv_, "click", function (e) {
            ...
            google.maps.event.addListener(this.containerDiv_, "dblclick", function (e) {
            ...
            google.maps.event.addListener(this.containerDiv_, "mousedown", function (e) {
                cMouseIsDown = true;
                cDraggingInProgress = false;
                cLatOffset = 0;
                cLngOffset = 0;
...
/*
     FILE ARCHIVED ON 02:58:14 Jan 11, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 10:40:54 May 31, 2022.
...
/*
playback timings (ms):
  captures_list: 1088.993
  exclusion.robots: 0.113
  exclusion.robots.policy: 0.104
  cdx.remote: 0.075
  esindex: 0.01
  LoadShardBlock: 1053.925 (3)
  PetaboxLoader3.datanode: 1089.177 (5)
  CDXLines.iter: 14.574 (3)
  load_resource: 271.104 (2)
  PetaboxLoader3.resolve: 225.802 (2)
*/
