jQuery(document).ready(function () {
    ...
    function colors_change_uncheckall(tthis) {
        ...
        var red_size = tthis.parents('.permissions-row').find('label.red').length;
        var green_size = tthis.parents('.permissions-row').find('label.green').length;
    ...
    function mycheckbox(tthis) {
        ...
        var childno = tthis.parents('ul').find('.ccheckbox[data-child="' + child + '"]').length;
        var childcheckedno = tthis.parents('ul').find('.ccheckbox[data-child="' + child + '"]:checked').length;
    ...
    function mycheckbox_parent(tthis) {
        ...
        var childsize = tthis.parents('ul').find('.ccheckbox[data-child="' + cpatent + '"]').length;
    ...
    function checkbox_wparent(tthis) {
        ...
        jQuery('[data-parent=' + parent + ']').each(function () {
            var childno = jQuery(this).closest('ul').find('.ccheckbox[data-child="' + parent + '"]').length;
            var childcheckedno = jQuery(this).closest('ul').find('.ccheckbox[data-child="' + parent + '"]:checked').length;
    ...
    $(window).on('load', function () {
        ...
        jQuery('input[type=checkbox].undetermined').each(function () {
            ccheckbox(jQuery(this));
        });

        var red_size = jQuery('.permissions-row').find('label.red').length;
        var green_size = jQuery('.permissions-row').find('label.green').length;
        if ((red_size > 0) || (green_size > 0)) {
            jQuery('.input-customrole').val('Yes');
        } else {
            jQuery('.input-customrole').val('No');
