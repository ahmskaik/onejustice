    ...
    var handleExportPDF = function () {
        jQuery(document).on('click', '.btn-exportpdf', function () {
            ...
            function load_pdf(imgname) {
                ...
                window.location.href = cp_route_name + '/browsers?' + form_data + '&from=' + date_from + '&to=' + date_to + img_link + '&exportType=' + type_export + '&export=' + process_type;
            }
