    ...
    var handleAjaxReport = function () {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                jQuery('.total-keywords').text(totalkeywords);
    ...
    var handleExportPDF = function () {
        jQuery(document).on('click', '.btn-exportpdf', function () {
            ...
            function load_pdf(imgname) {
                ...
                window.location.href = cp_route_name + '/keywords?' + form_data + '&from=' + date_from + '&to=' + date_to + img_link + '&exportType=' + type_export + '&export=' + process_type;
            }
