var reportFactory = function () {
    ...
    var handleAjaxReport = function () {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                totalactiveusers = data.data.active;
                ...
                input_wlbl();
                jQuery('.total-visitors').text(totalvisitors);
                jQuery('.total-pageviews').text(totalpageviews);
                jQuery('.total-activeusers').text(totalactiveusers);
    ...
    var handleExportPDF = function () {
        jQuery(document).on('click', '.btn-exportpdf', function () {
            var img = save_chart($('#report_chart_visitors').highcharts());
            var date_from = jQuery('.txt-inputfrom').val();
            var date_to = jQuery('.txt-inputto').val();
            var thisclick = jQuery(this);
            ...
            function load_pdf(imgname) {
                ...
                window.location.href = cp_route_name + '/visitors?' + form_data + '&from=' + date_from + '&to=' + date_to + img_link + '&exportType=' + type_export + '&export=' + process_type;
            }
