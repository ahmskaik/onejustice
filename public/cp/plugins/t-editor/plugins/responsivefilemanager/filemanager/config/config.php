...
$config = array(
	...
	*/
	...
	|
	*/
    //TODO : point to the root's relative path, without using 'public'
	'upload_dir' => '/ebina/public/uploads/editor/',
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => 'uploads/editor_thumbs/',
...
//$config["my_base_url"]=$_SERVER['DOCUMENT_ROOT'].$config["upload_dir"];
$config["current_path"]=$_SERVER['DOCUMENT_ROOT'].$config["upload_dir"];
return array_merge(
	$config,
	array(
