...
if (isset($_POST['submit'])) {
    ...
    <head>
        ...
        <link href="../resources/assets/css/jplayer.blue.monday.css" rel="stylesheet" type="text/css">
        <!--[if lt IE 8]>
        <style>
        ...
        <script src="../resources/assets/js/jPlayer/jquery.jplayer/jquery.jplayer.js"></script>
        ...
        <div class="row-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <?php if ($show_total_size) { ?>
                    <li>
                        <small class="hidden-phone"><span title="<?php echo trans('total size') . $MaxSizeTotal; ?>"><?php echo trans('total size') . ": " . makeSize($sizeCurrentFolder) . (($MaxSizeTotal !== false && is_int($MaxSizeTotal)) ? '/' . $MaxSizeTotal . ' ' . trans('MB') : ''); ?></span></small>
                    </li>
                <?php } ?>
            </ul>
        </div>
