...
@section('js')
    ...
    <script src="cp/js/pages/category/list.js?v=1.0" type="text/javascript"></script>
@endsection
                ...
                <form class="horizontal-form search-form kt-form kt-form--fit">
                    <div class="row">
                        <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                            <label class="lblinput">{{trans('admin/category.category_name')}}</label>
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        {{trans('admin/category.categories_list')}}
                    </h3>
                </div>
            ...
            <div class="kt-portlet__body" id="data-list">
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tr>
                        ...
                        <th>{{trans('admin/category.parent_category')}}</th>
                        <th>{{trans('admin/category.category_status')}}</th>
                        <th>{{trans('admin/dashboard.created_by')}}</th>
                        <th>{{trans('admin/dashboard.creation_date')}}</th>
