...
@section('js')
    ...
    <script src="cp/js/pages/newsletters/list.js?v=1.0.1" type="text/javascript"></script>
@endsection
                        ...
                        <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                            ...
                            <div class="kt-input-icon kt-input-icon--left">
                                <select class="form-control kt-input searchable-list" id="language_id"
                                        name="language_id" data-col-index="3" data-column="3">
            ...
            <div class="kt-portlet__body" id="data-list">
                <table class="table table-striped table-bordered table-hover table-checkable order-column"
                    ...
                    <tr>
                        ...
                        <th>Title</th>
                        <th>Date</th>
                        <th class="kt-align-center">{{trans('admin/dashboard.language')}}</th>
