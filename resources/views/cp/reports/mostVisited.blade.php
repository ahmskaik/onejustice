...
@section('js')
    ...
    <script src="cp/js/reports/report-google-mostVisited.js" type="text/javascript"></script>
@stop
                ...
                <form class="horizontal-form search-form kt-form kt-form--fit stiscky-inputs">
                    <div class="row">
                        <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                            <label class="lblinput">Max No.</label>
                            <input type="number" name="maxNo" class="form-control txtinput-filter-number txt-maxno"
                                   maxlength="3" placeholder="" value="5"/>
                        </div>
            ...
            <div class="kt-portlet__body">
                <div class="totalshow-area">
                    ...
                    <div class="total-show-region clearfix">
                        ...
                        <div class="totalshow">
                            <span>Total Pages Views:</span>
                            <p class="total-pageviews"></p>
                        </div><!-- totalshow -->
                    </div>
                </div><!-- totalshow area -->
