...
@section('js')
    ...
    <script src="cp/js/reports/report-google-referrers.js" type="text/javascript"></script>
@stop
        ...
        <div class="kt-portlet kt-portlet--mobile kt-portlet--head-sm search-form-rg green">
            ...
            <div class="kt-portlet__body">
                <form class="horizontal-form search-form kt-form kt-form--fit stiscky-inputs">
                    <div class="row">
                        <div class="col-lg-2 kt-margin-b-10-tablet-and-mobile pt-lg-4">
                            <span class="font-weight-bold">Search Date</span>
                        </div>
