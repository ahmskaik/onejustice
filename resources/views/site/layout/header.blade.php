<header class="left relative" id="mvp-main-head-wrap">
    <nav class="left relative" id="mvp-main-nav-wrap">
        <div class="left relative mvp-nav-menu left " id="mvp-main-nav-top">
                                        ...
                                        @if($language['id'] != $active_language['id'])
                                            <li class="menu-item">
                                                <a href="changeLang/{{$language['iso_code']}}">
                                                    ...
                                                    {{$language['translations']->{$locale}??$language['translations']->{$fallbackLanguage} }}</a>
                                            </li>
                                        @endif
                                    @endforeach
                                </ul>
                            ...
                            <div class="mvp-nav-bot-right-in">
                                <div class="mvp-nav-bot-cont left">
                                    <div class="mvp-nav-bot-left-out">
                                        ...
                                        <div class="mvp-nav-bot-left-in" style="display: flex">
